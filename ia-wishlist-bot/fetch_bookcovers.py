...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--google",
        help="Enter the ISBN Number to get Bookcovers using Google Books API",
    )

    parser.add_argument(
        "--amazon",
        help="Enter the ISBN Number to scrape Bookcovers using Amazon Website",
    )

    parser.add_argument(
        "--betterworld",
        help="Enter the ISBN Number to get bookcovers using Betterworld Books",
    )
